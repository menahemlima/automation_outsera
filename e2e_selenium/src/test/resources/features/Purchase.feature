...
@purchase
Scenario Outline: Purchase and Checkout with dynamic data
  Given I am logged on Swag Labs
  When I add "<product01>" and "<product02>" to the cart
  And I complete the checkout process informing user dynamic data
  Then I should see the order confirmation message "<confirmationMessage>"

  Examples: Valid Purchases
    | product01            | product02              | confirmationMessage        |
    | Sauce Labs Backpack  | Sauce Labs Bike Light  | Thank you for your order!  |